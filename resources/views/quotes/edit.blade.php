                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="mb-3">
                                ...
                                @if ($quotation->file_propuesta)
                                <a href="{{ $quotation->file_propuesta }}" target="_blank">Ver propuesta</a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="note" value="{{ $quotation->note }}" >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="closing_date" id="closing_date" value="{{ $quotation->closing_date }}">
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-6">
                            <div class="mb-3">
                                <label for="name" class="form-label">% de Cierre</label>
                                <input type="text" class="form-control" name="closing_percentage" id="closing_percentage" value="{{ $quotation->closing_percentage }}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="mb-3">
